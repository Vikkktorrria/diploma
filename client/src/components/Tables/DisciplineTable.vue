<template>
  <div class="change_data_modal_table">
    ...
    <p class="table_item"><strong>Код:</strong><input :value="this.discipline.discipline_code" class="table_data_input disabled" disabled></p>
    <p class="table_item"><strong>Начало <br> преподавания <br> (семестр):</strong><input :value="this.discipline.taught_per_semester" class="table_data_input disabled" disabled></p>
    <p class="table_item"><strong>Название:</strong><input :value="this.discipline.discipline_name" class="table_data_input"></p>
    <p class="table_item"><strong>Модуль:</strong><input :value="this.discipline.module_name" class="table_data_input"></p>
